...
gui_lagometer = 1
gui_mode_buttons = 0
gui_pane_left_size = 126
gui_pane_right_size = 182
gui_quit_dialog = 1
gui_slist_select = 32
gui_slist_skip = 1
gui_throttlemeter = 1
...
irc_logging = 0
irc_logmask = %n-%c.log
irc_nick1 = usuario_live
irc_nick2 = usuario_live_
irc_nick3 = usuario_live__
irc_nick_hilight = 
irc_no_hilight = NickServ,ChanServ
irc_part_reason = Saliendo
irc_quit_reason = Saliendo
irc_raw_modes = 0
irc_real_name = Usuario predeterminado de Meikian Live
irc_servernotice = 0
irc_skip_motd = 0
irc_user_name = Live
irc_wallops = 0
