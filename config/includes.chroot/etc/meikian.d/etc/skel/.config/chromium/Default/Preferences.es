{
   ...
   "browser": {
      ...
      "last_clear_browsing_data_time": "13052391835945146",
      "last_known_google_url": "https://www.google.es/",
      "last_prompted_google_url": "https://www.google.es/",
   ...
   "download": {
      "default_directory": "/home/user/Descargas",
   ...
   "extensions": {
      ...
      "known_disabled": [  ],
      "last_chrome_version": "35.0.1916.153",
      "settings": {
         "ahfgeienlihckogmohjhadlkjgocpleb": {
            ...
            "from_bookmark": false,
            "from_webstore": false,
            "install_time": "13036764108971500",
            "location": 5,
            "manifest": {
               "app": {
                  "launch": {
         ...
         "eemcgdkfndhakfknompkggombfjjjeno": {
            ...
            "install_time": "13036764108924546",
            "location": 5,
            "manifest": {
               "chrome_url_overrides": {
                  "bookmarks": "main.html"
         ...
         "ennkphjdgehloodpbhlhldgbnhmacadg": {
            ...
            "initial_keybindings_set": true,
            "install_time": "13052391734323472",
            "location": 5,
            "manifest": {
               "app": {
                  "background": {
            ...
            "path": "/usr/lib/chromium/resources/settings_app",
            "preferences": {
         ...
         "mfehgcgbbipciphmccgaenjidiccnmng": {
            ...
            "from_bookmark": false,
            "from_webstore": false,
            "install_time": "13036764108970982",
            "location": 5,
            "manifest": {
               "app": {
                  "launch": {
         ...
         "mgndgikekgjfcpckkfioiadnlibdjbkf": {
            ...
            "install_time": "13052391734322638",
            "location": 5,
            "manifest": {
               "app": {
                  "launch": {
            ...
            "page_ordinal": "n",
            "path": "/usr/lib/chromium/resources/chrome_app",
            "preferences": {
         ...
         "nmmhkkegccagdldgiimedpiccmgmieda": {
            ...
            "initial_keybindings_set": true,
            "install_time": "13052391758229741",
            "lastpingday": "13052386801326001",
            "location": 10,
            "manifest": {
               "app": {
                  "background": {
               ...
               "current_locale": "es",
               "default_locale": "en",
               "description": "Google Wallet para contenidos digitales",
               "display_in_launcher": false,
               "display_in_new_tab_page": false,
               "icons": {
         ...
         "pafkbggdmjlpgkdkcbjmhmfcdpncadgh": {
            ...
            "content_settings": [  ],
            "creation_flags": 1,
            "events": [ "alarms.onAlarm", "identity.onSignInChanged", "notifications.onButtonClicked", "notifications.onClicked", "notifications.onClosed", "notifications.onPermissionLevelChanged", "notifications.onShowSettings", "pushMessaging.onMessage", "runtime.onInstalled", "runtime.onStartup", "runtime.onSuspend" ],
            "from_bookmark": false,
            "from_webstore": false,
            "incognito_content_settings": [  ],
            "incognito_preferences": {
            ...
            "initial_keybindings_set": true,
            "install_time": "13052391734324299",
            "location": 5,
            "manifest": {
               "background": {
                  "persistent": false,
               ...
               "permissions": [ "alarms", "identity", "metricsPrivate", "notifications", "pushMessaging", "storage", "tabs", "webstorePrivate", "\u003Call_urls>" ],
               "version": "1.2.0.1"
            },
            "path": "/usr/lib/chromium/resources/google_now",
            "preferences": {
   ...
   "intl": {
      "accept_languages": "es-ES,es"
   },
   "invalidator": {
      "client_id": "8c6O385xFMxLV4h3CGAxjw=="
   },
   "media": {
      "device_id_salt": "+Z7VFdKf1Lq6FvlmksnEYA=="
   },
   "net": {
   ...
   "session": {
      ...
      "startup_urls_migration_time": "13052391734145281"
   },
   "translate": {
      "enabled": false
   },
   "translate_blocked_languages": [ "es" ],
