...
project_start = 2014
project_current = date.today().year
...
copyright = u'%d - %d, The Meikian Project - Algunos derechos reservados - CC-BY-SA' % (project_start, project_current)
...
# The following section of code was copied from the conf.py file of OctoPrint
...
#   u'The Meikian Project', 'meikian', 'Distribución basada en Debian GNU/Linux.',
#   'Miscellaneous'),
#]
#
## Documents to append as an appendix to all manuals.
